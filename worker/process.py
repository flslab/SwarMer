...
class WorkerProcess(multiprocessing.Process):
    def __init__(self, count, process_id, gtl, el, shared_el, results_directory, k, sorted_neighbors, fid_to_dist,
                 start_time, is_standby=False, group_ids=None, standby_id=0, sid=0, group_id=None, radio_range=2000):
        ...
        self.context = WorkerContext(
            ...
            fid_to_dist, is_standby, group_ids, standby_id, sid, group_id, radio_range)
